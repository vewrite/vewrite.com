  ...
  <main  id="Header" :class="{'scrolled': isScrolled}"> 
    <div class="mobile-switch" @click="toggleMobileNav">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M28 14C28 21.732 21.732 28 14 28C6.26801 28 0 21.732 0 14C0 6.26801 6.26801 0 14 0C21.732 0 28 6.26801 28 14Z" fill="#8D00FB"/>
  ...
  <nav id="MobileNav" :class="mobileState">
    <div class="close" @click="toggleMobileNav">
      <svg width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M23.8995 24.799C18.4322 30.2663 9.56785 30.2663 4.10051 24.799C-1.36683 19.3317 -1.36683 10.4673 4.10051 5C9.56785 -0.467336 18.4322 -0.467336 23.8995 5C29.3668 10.4673 29.3668 19.3317 23.8995 24.799Z" fill="#8D00FB"/>

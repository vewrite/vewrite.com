  ...
  <section class="build">
    ...
    <div class="column-right">
      ...
      <div class="build-box">
        ...
        <p><nuxt-link to="/product/project-management" class="button">Explore Projects</nuxt-link></p>
      </div>
      <div class="build-box">
        ...
        <p><nuxt-link to="/product/content-creation" class="button">Explore Content Creation</nuxt-link></p>
      </div>
    </div>
  </section>
</template>

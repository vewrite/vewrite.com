<template>
  <NuxtLayout>
    <main id="terms" class="w-three-quarters page-top">
    ...
    <ol>
        ...
        <li><a href="#payment">FEES AND PAYMENT</a></li>
        ...
        <li><a href="#usrights">U.S. GOVERNMENT RIGHTS</a></li>
        <li><a href="#sitemanage">SITE MANAGEMENT</a></li>
        <li><a href="#privacypolicy1">PRIVACY POLICY</a></li>
        <li><a href="#copyright1">COPYRIGHT INFRINGEMENTS</a></li>
    ...
    <p>These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you") and Vewrite, LLC ("Company", "we", "us", or "our"), concerning your access to and use of the https://www.vewrite.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the "Site"). We are registered in Massachusetts, United States and have our registered office at 25 John St, Brookline, MA 02446. Our VAT number is ‭333523355‬. You agree that by accessing the Site, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
    ...
    <h2 id="payment">5. FEES AND PAYMENT</h2>
    ...
    <h2 id="cancel">6. CANCELLATION</h2>
    ...
    <p>If you are unsatisfied with our services, please email us at support@vewrite.com or call us at 15083607982.</p>
    ...
    <ul>
        ...
        <li>Illicit materials or content</li>
    </ul>
    ...
    <h2 id="submissions">11. SUBMISSIONS</h2>
    ...
    <h2 id="usrights">12. U.S. GOVERNMENT RIGHTS</h2>
    ...
    <h2 id="sitemanage">13. SITE MANAGEMENT</h2>
    ...
    <h2 id="privacypolicy1">14. PRIVACY POLICY</h2>
    <p>We care about data privacy and security. Please review our Privacy Policy: <a href="https://vewrite.com/legal/privacy" target="_blank">https://vewrite.com/legal/privacy</a>. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.</p>

    <h2 id="copyright1">15. COPYRIGHT INFRINGEMENTS</h2>
    ...
    <p>If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA's Supplementary Procedures for Consumer Related Disputes ("AAA Consumer Rules"), both of which are available at the AAA website <a href="http://www.adr.org" target="_blank">www.adr.org</a>. Your arbitration fees and your share of arbitrator compensation shall be governed by the AAA Consumer Rules and, where appropriate, limited by the AAA Consumer Rules. The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in Norfolk, Massachusetts. Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.</p>
    
    <p>If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Norfolk, Massachusetts, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms of Use.</p>
    ...
    <p><strong>Vewrite, LLC</strong></p>

    <p><strong>Phone: 15083607982</strong></p>
    <p><strong>support@vewrite.com</strong></p>
